            ...
            Container(
              ...
              child: Column(
               ...
               Container(
                   ...
                   child: Image.asset("images/location2.0.png",height: height*0.24,width: width*1,fit: BoxFit.fill,)),

                    SizedBox(height: height*0.075,),

                      Container(
                        margin: EdgeInsets.only(left: width*0.075,right: width*0.05),
                        child: Text("Set your location services",
                      ...
                      BlueButton(text: "Set location services", onpress: (){
