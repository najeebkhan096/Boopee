        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                margin: EdgeInsets.only(right: width*0.05,top: height*0.0175),
                child: Row(
                  children: [
                    InkWell(
                      onTap: (){
                      ...
                      child: Container(
                        alignment: Alignment.centerLeft,
                        margin: EdgeInsets.only(left: width*0.025,top: height*0.0175),
                        child: CircleAvatar(
                          radius: height*0.02,
                          backgroundColor: Color(0xffD7D3D0),
                          child: CircleAvatar(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(
                        children: [
                          ...
                          Container(
                            width: width*0.35,
                            child: Text("Doggo lovers club - French",
                    ...
                    SizedBox(height: height*0.015,),
                      Container(
                        ...
                        child: Text("You have a cute doggo, and you’re based in France? Join our group for..." ,style: myStyle.inter_79716B(height*0.017, FontWeight.w400),
                        ),
                      ),
                      SizedBox(height: height*0.0175,),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("Join the biggest group in Morocco of dogs, meet new people" ,style: myStyle.inter_79716B(height*0.017, FontWeight.w400),
                        ),
                      ),
                      SizedBox(height: height*0.0175,),
